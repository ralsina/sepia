...
describe Sepia::Watcher do
  ...
  describe "Watcher" do
    temp_dir = ""
    storage : Sepia::FileStorage
    watcher : Sepia::Watcher
    ...
    after_each do
      begin
        ...
        # Ignore errors if watcher was never started
      end
    ...
    describe "#initialize" do
      it "creates a watcher with storage backend" do
        new_watcher = Sepia::Watcher.new(storage)
        new_watcher.storage.should eq(storage)
